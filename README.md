...
Este es un espacio de bienvenida y (meta)discusión sobre temas de la comunidad de Codeando México.
...
6. Apuntas hacia los **canales digitales** que utiliza la comunidad.
...
3. **Construcción consciente/*proactiva*.** Buscamos contribuir con nuevas formas de abordar los problemas comunes fomentando y canalizando el pensamiento crítico hacia el del desarrollo de herramientas tecnológicas. Queremos habilitar transformaciones de fondo, no solucionismo. 

4. **Inclusión para la libre participación/*proactiva*.** Somos una comunidad que valora, respeta y buscar dar espacio a todas las voces. Queremos generar dentro y fuera de nuestra comunidad espacios que garanticen la participación libre de abuso/odio y discriminación, que reconozcan el valor de cada persona como una pieza fundamental.
...
## Aprende más sobre hacking cívico
...
- [chihacknight](https://github.com/chihacknight)
